...
python3 -m pip install --upgrade pip setuptools wheel; echo "installing pep8"; sudo pip3 install pep8; echo "pep8 installed"; sudo pip3 install pylint; echo "pylint installed"
